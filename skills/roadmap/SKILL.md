...
Personal projects only (your personal GitHub account, write access). A repo owned by
someone else has read-only tracker issues — never open or edit them. Reconcile against git, not memory.
