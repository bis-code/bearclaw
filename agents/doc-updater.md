...
name: doc-updater
model: sonnet
description: "Use after a feature or schema change to sync README, OpenAPI specs, inline godoc/javadoc, and CHANGELOG. Updates existing docs only — does not author new ones from scratch."
allowed_tools:
  - Read
  - Glob
  - Grep
