...
name: tdd-guide
model: sonnet
description: "Use when starting new service-layer logic or fixing a bug — writes the failing test first, then guides red-green-refactor. Especially for Go handlers, service code, and API endpoints where TDD is high-leverage."
allowed_tools:
  - Read
  - Glob
  - Grep
