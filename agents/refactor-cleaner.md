...
model: sonnet
description: "Use when removing dead code, deduplicating logic, or cleaning unused imports/exports — especially after a feature lands and obsoletes scaffolding. Verifies each removal with tests before keeping."
allowed_tools:
  - Read
  - Glob
  - Grep
